...
def CFPLncLoc(X, y, X_ho, y_ho, BATCH_SIZE, EPOCHS):
    ...
    return avg_AP, avg_HL, avg_avgF1, avg_MiP, avg_MiR, avg_MiF, avg_MaAUC, avg_MiAUC, avg_Pat1,\
           avg_AP_ho, avg_HL_ho, avg_avgF1_ho, avg_MiP_ho, avg_MiR_ho, avg_MiF_ho, avg_MaAUC_ho,\
           avg_MiAUC_ho, avg_Pat1_ho